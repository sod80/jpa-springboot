...
insert into manufacturer (id, name, location_id, average_yearly_sales, founded_date) values (1, 'Fender Musical Instruments Corporation', 3, 25000000, '1946-01-01');
insert into manufacturer (id, name, location_id, average_yearly_sales, founded_date) values (2, 'Gibson Guitar Corporation', 42, 32000000, '1902-01-01');
